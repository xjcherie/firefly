...
/**
 * create by cherie on 06/03/2019.
 */
public class PdfSave {

//        new File("/home/amarsoft/AFm.pdf");
...
//        //将PDF格式文件转成base64编码
//        String base64String = getPDFBinary(new File("/Users/cherie/IBLLC-US-485881.jpg"));
...
//        base64StringToPDF(base64String);
    ...
    /**
     * http://www.kmrlyy.com/zgnma/33463.html
     * 将base64编码转换成PDF
     *
    ...
    static void base64StringToPDF(String base64sString) {
        ...
        try {
            ...
            File file = new File("/Users/cherie/test.pdf");
            //创建到指定文件的输出流
