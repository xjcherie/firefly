...
//     * decrypt functions.
//     */
//    private static void skip32(byte[] key, int[] buf, boolean encrypt) {
//        int k; /* round number */
//        int i; /* round counter */
//        int kstep;
//        int wl, wr;
...
//
//    /**
//     * 编码长度从10个字符起。10个字符的最小数字为1000000000L。int类型32字节，8字节的随机数，共40字节，能支持最大13个字符的编码
//     *
//     * @param value 需要加密的数字
//     * @return 生成的最后数字
//     */
//    static long genCode(int value, byte[] dataKey) {
//        int encData = encrypt(value, dataKey);
//        int absEncData = Math.abs(encData);
//        long v = 0;
//        // 生成混淆数字
//        v |= absEncData;
//        // 右移动8位
...
//        // 放置8位的随机数字
//        v = v | randNum(8);
//        // 为了保证最小10位数字，需要加上十位数字的最小数字
//        v = v + 1000000000L;
//        return v;
//    }
//
//    private static int randNum(int bitLength) {
...
//        }
//        if (bitLength > Integer.SIZE) {
//            throw new RuntimeException("can not support bitlength: " + bitLength);
//        }
//        BitSet bs = new BitSet(bitLength);
//        bs.set(0, bitLength - 1);
//        int maxValue = conver2Int(bs);
//        return RandomUtils.nextInt(0, maxValue);
//    }
//
//    private static int conver2Int(BitSet bs) {
//        byte[] bytes = bs.toByteArray();
//        ByteBuffer bb = ByteBuffer.wrap(bytes);
//        return bb.getInt();
//    }
//
//    static long generate(int internal, byte[] dataKey, byte[] vKey) {
//        long publicCode = encrypt(internal, dataKey);
//        long verifyCode = encrypt(internal, vKey);
//        return publicCode * 232 + verifyCode % 232;
//    }
//
//    public static void main(String[] args) {
//        byte[] key = "018121932a".getBytes(StandardCharsets.UTF_8);
//        int min = 0;
//        int max = Integer.MAX_VALUE / 2;
//        for (int i = min; i < max; i++) {
//            long v = genCode(i, key);
//            int length = String.valueOf(v).length();
//            if (length < 10) {
//                System.out.println("i: " + i + " , " + v);
//            } else if (length > 12) {
//                System.out.println("too long i: " + i + " , " + v);
//            }
//        }
//    }
}
